    ...
    render() {
        return (
            <div className='advice-wrapper'>
                <span id='adviceCount' role='text'>advice #{this.state.id}</span>
                <p id='advicePh' role='text'>{this.state.quote}</p>
                ...
                <div className='dice-ph' role='button' onClick={this.getQuote}>
